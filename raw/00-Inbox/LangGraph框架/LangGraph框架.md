...
![mermaid\-diagram\-2026\-04\-12\-143930\.png](图片和附件/mermaid-diagram-2026-04-12-143930.png)
...
3. **Reducer（归并函数）**：在 LangGraph 中，所有节点返回的都是“局部更新结果”，**Reducer 是用于合并多个节点输出更新的机制**。 **将每个节点返回的“局部状态更新”统一合并进全局的 State。**
...
**（注意：如果你只需要用路由功能不去更新状态的话，请直接用条件边！！！）**
...
![mermaid\-diagram\-2026\-04\-16\-204854\.png](图片和附件/mermaid-diagram-2026-04-16-204854.png)
...
![mermaid\-diagram\-2026\-04\-22\-165101\.png](图片和附件/mermaid-diagram-2026-04-22-165101.png)
